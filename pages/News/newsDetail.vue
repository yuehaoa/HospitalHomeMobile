<template>
	<view>
		<statusBar></statusBar>
		<view class="padding-tb-sm flex bg-gradual-theme">	<!--四个按钮-->
		...
		<view class="margin">
			<view>
				<p class="margin-tb text-lg"><strong>每日一景|四川长安：稻谷翻金浪 山村美如画</strong></p>
			...
			<view>
				<p class="text-grey text-sm margin-tb">责任编辑：荣毅 袁微</p></view>
			</view>
		</view>
</template>
